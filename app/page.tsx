...
// Rate limiting: Maximum 2 claims per 24 hours per device (shared between USDC and EURC)
...
export default function FaucetPage() {
  ...
  const handleClaim = async () => {
    ...
    if (!rateLimitCheck.allowed) {
      ...
      setErrorMessage(`Rate limit exceeded. Maximum 2 claims per 24 hours (shared between USDC and EURC). Please try again in ${hoursUntilReset} hour(s).`);
        ...
        <div className="space-y-3">
          ...
          {rateLimitInfo !== null && rateLimitInfo.remainingRequests === 0 && (
            <Alert className="border" style={{ background: "#050B18", borderColor: "#EF4444" }}>
              ...
              <AlertDescription style={{ color: "#9CA3AF" }} className="mt-2">
                You have reached the maximum of 2 claims per 24 hours (shared between USDC and EURC).
